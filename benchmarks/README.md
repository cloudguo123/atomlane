...
validate against `project-result.schema.json` version 1.1. Version 1.1 requires
...
limits, includes supervisor resource usage, and limits containment to the client
plus normally inherited Windows descendants. Broker-created WSL, Docker, WMI,
