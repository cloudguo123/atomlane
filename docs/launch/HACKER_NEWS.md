...
AtomLane is an MPL-2.0 open-source Codex plugin, free for personal and commercial use, built around one universal safety core, platform-native execution, and workload-tailored acceleration for local build, test, Docker, research, and batch workflows.
